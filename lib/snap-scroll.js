...
Scroll.prototype.addListeners = function() {
  this.els.container.addEventListener(pointer.up, this.tapHandler);
...
Scroll.prototype.removeListeners = function() {
  this.els.container.removeEventListener(pointer.up, this.tapHandler);
